...
# Initialize Gemini client with inline API key
def get_gemini_client():
    """Get Gemini client with inline API key"""
    api_key = "AIzaSyAa9nJsVFB4sF-poysy255ARhsrHfVJ7aY"
        ...
        for attempt in range(max_retries):
            try:
                ...
                if "500" in error_msg or "INTERNAL" in error_msg:
                    ...
                    logging.error("Invalid API key - check inline Gemini API key configuration")
                    return False
